...
Route::group(['prefix' => 'user', 'middleware' => 'auth'], function() {
    // Update password -- using built-in  change password controller
    Route::get('/update-password', [ChangePasswordController::class, 'userPasswordChange'])->name('user-password.change');
    Route::post('/update-password', [ChangePasswordController::class, 'userPasswordUpdate'])->name('user-password.update');


    // User Profile -- using built-in userprofilecontroller
